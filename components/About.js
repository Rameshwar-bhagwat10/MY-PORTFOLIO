...
const skills = [
	{ name: 'React', percent: 95, color: 'linear-gradient(90deg,#7f5af0,#2cb67d)' },
	{ name: 'Next.js', percent: 90, color: 'linear-gradient(90deg,#ff6ac1,#1982c4)' },
	{ name: 'Node.js', percent: 85, color: 'linear-gradient(90deg,#43e97b,#38f9d7)' },
	{ name: 'MongoDB', percent: 80, color: 'linear-gradient(90deg,#f7971e,#ffd200)' },
	{ name: 'Python', percent: 75, color: 'linear-gradient(90deg,#f857a6,#ff5858)' },
];
			...
			<div className={styles.aboutContainer}>
				...
				>
					...
					<p className={styles.intro}>
						I&apos;m Rameshwar, a passionate full-stack developer who builds scalable web
						applications for real-world users.
					</p>
					<p className={styles.intro}>
					...
					<div className={styles.infoGrid}>
						...
						<div>
							...
							<span className={styles.infoValue}>rameshwarbhagwat019@gmail.com</span>
						</div>
						<div>
